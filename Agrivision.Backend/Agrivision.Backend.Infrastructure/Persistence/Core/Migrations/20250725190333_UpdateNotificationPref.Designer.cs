...
namespace Agrivision.Backend.Infrastructure.Persistence.Core.Migrations
{
    ...
    [Migration("20250725190333_UpdateNotificationPref")]
    partial class UpdateNotificationPref
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.ClearedConversation", b =>
                {
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.ClearedNotification", b =>
                {
                    b.Property<DateTime>("ClearedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("ClearedAt", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("ClearedNotifications", (string)null);
                });

            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.ConversationInviteLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.ConversationMember", b =>
                {
                    b.Property<Guid>("ConversationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.NotificationPreference", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.ReadNotification", b =>
                {
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.ConversationInviteLog", b =>
                {
                    b.HasOne("Agrivision.Backend.Domain.Entities.Core.Conversation", "Conversation")
                        .WithMany()
            ...
            modelBuilder.Entity("Agrivision.Backend.Domain.Entities.Core.ReadNotification", b =>
                {
                    b.HasOne("Agrivision.Backend.Domain.Entities.Core.Notification", "Notification")
